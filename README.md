...
I want you to improve this c code as much as possible - to make it fastest!!! Using this c code - I am able to get this ```dx-85753447:~/dx{main}$ ./main
INFO: Folder does not exist. Creating 'modules/'...
INFO: Using standard 'write' method for initial creation.
Starting file creation with 8 threads...

Finished creating/updating 1000 files.
Total time taken: 29.65 ms
dx-85753447:~/dx{main}$ ./main
INFO: Folder exists. Using fast 'mmap' overwrite method.
Starting file creation with 8 threads...

Finished creating/updating 1000 files.
Total time taken: 37.14 ms```

Here is the code ```#include <fcntl.h>
#include <unistd.h>
#include <sys/stat.h>
#include <sys/types.h>
#include <sys/mman.h>
